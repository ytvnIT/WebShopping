					...
					<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
									...
									<img src="images/ph1.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{$url->{{$url->getSingle()}})}}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
								...
								<div class="item-info-product ">
									<h4><a href="{{$url->{{$url->getSingle()}})}}">Apple Iphone 6</a></h4>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="{{$url->{{$url->getSingle()}})}}">Apple Iphone 6s</a></h4>
									<div class="info-product-price">
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="{{$url->{{$url->getSingle()}})}}">Watches</a></h4>
									<div class="info-product-price">
