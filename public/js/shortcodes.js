	...
	container.find('.sc_skills_arc:not(.inited)').each(function () {
		...
		var o = {
			...
			diagram: function(){
				...
				r.circle(c, c, Math.round(w/2)).attr({ stroke: 'none', fill: BESTDEALS_GLOBALS['template_skin_bg_color'] ? BESTDEALS_GLOBALS['template_skin_bg_color'] : '#ffffff' });
				
				var title = r.text(c, c, arc.data('caption')).attr({
					font: Math.round(rad*0.75)+'px "'+BESTDEALS_GLOBALS['template_font']+'"',
					fill: BESTDEALS_GLOBALS['template_skin_color'] ? BESTDEALS_GLOBALS['template_skin_color'] : '#909090'
				}).toFront();
